...
export default function BrandInfoForm() {
  ...
  return (
    <Card className="rounded-3xl p-6 space-y-6 bg-white w-full">
      <h3 className="text-2xl font-semibold text-slate-800">Informasi Brand</h3>
      ...
      {/* Sosial Media / Kontak */}
      <div className="space-y-1">
        <label className="text-sm font-medium">Sosial Media / Kontak</label>
        <Input
