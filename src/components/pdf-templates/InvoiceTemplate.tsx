        ...
        {data.template === "STYLE_A" ? (
          ...
          <>
            ...
            <View style={{ alignItems: "center", marginVertical: 12 }}>
              ...
              >
                ...
                <Text style={{ color: brandColor, marginTop: 6, fontSize: 12 }}>
                  {data.client?.name || "-"}
                </Text>
              </View>
            </View>
            ...
            >
              ...
              <View style={{ marginTop: 12 }}>
                ...
                >
                  <Text style={{ fontSize: 12, color: "#dc2626" }}>Diskon</Text>
          ...
          <>
            ...
            <View>
              ...
              >
                <Text
                  style={{ flex: 4, fontWeight: "bold", color: brandColor }}
                >
                  Deskripsi
                </Text>
                <Text style={{ flex: 1, textAlign: "center" }}>Jumlah</Text>
                <Text style={{ flex: 2, textAlign: "right" }}>Harga</Text>
                <Text style={{ flex: 2, textAlign: "right" }}>Nominal</Text>
              </View>
